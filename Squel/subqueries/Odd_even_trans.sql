...
ifnull(
    ...
    where t1.transaction_date = t2.transaction_date and t2.amount % 2 != 0), 0) as odd_sum,
    ifnull(
        (select sum(amount)
        from transactions t2
        where t1.transaction_date = t2.transaction_date and t2.amount % 2 = 0), 0) as even_sum 
