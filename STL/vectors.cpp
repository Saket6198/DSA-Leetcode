...
cout<<counter<<endl;
auto maxi = max_element(a7.begin(), a7.end()) - a7.begin();
cout<<maxi<<endl; //returns the index of the maximum element present in the vector
auto maxiv = max_element(a7.begin(), a7.end()); 
cout<<*maxiv<<endl; //returns the maximum element VALUE present in the vector
